...
<a name="Staff"></a>
**Course Staff** <br />
The course instructor for this year is Kathryn (Kate) Weaver, a 4th year Ph.D. Candidate in the Biology department at Johns Hopkins University. Kate has B.S. degrees in Biochemistry & Molecular Biology as well as Mathematics from Bethel University. Kate's Ph.D. research is focused on computational biology, specifically applying computational models and machine learning to the study of gene regulation and human reproduction.
...
**Note:** This course will be graded out of 100 while 16 + 10 + 8 + 8 + 60 = 102.

<a name="Software"></a>
**Software & Logistics** <br />
* [Github](https://github.com/) will be used to post and turn in all assignments as well as directly provide feedback to students. If you do not have a GitHub account, create a free account. Once you have a GitHub account, fill out this google form (https://forms.gle/AhbUtMGoiyJCHeui6)[https://forms.gle/AhbUtMGoiyJCHeui6] so that the instructor can add you to the course GitHub "Organization".
